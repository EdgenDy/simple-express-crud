const tbody = document.getElementById("table-body");
  ...
  function writeToTable(array) {
    ...
    for (const rowData of array) {
      ...
      const anchor = document.createElement("a"); // <a href=""></a>
      anchor.href = "./by-email/?user_email=" + rowData["email"]; // <a href="./by-email/?user_email=email@gmail.com"></a>
      anchor.textContent = "Update User";
      cell6.appendChild(anchor); // adding the button to <td></td>
    }
  }
